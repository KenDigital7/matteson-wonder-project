        ...
        <div className="max-w-6xl mx-auto space-y-12">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <Card className="text-center hover:scale-105 transition-transform duration-300 bg-white shadow-lg">
              <CardContent className="p-8">
                <div className="flex justify-center mb-6">
                  <img src="/images/Icons/Edu.Equality.png?v=2" alt="Educational Equity" className="w-60 h-60 object-contain" />
                </div>
                <h4 className="text-xl font-semibold mb-4 text-gray-900">Educational Equity</h4>
            ...
            <Card className="text-center hover:scale-105 transition-transform duration-300 bg-white shadow-lg">
              <CardContent className="p-8">
                <div className="flex justify-center mb-6">
                  <img src="/images/Icons/Community.png?v=2" alt="Community Building" className="w-60 h-60 object-contain" />
                </div>
                <h4 className="text-xl font-semibold mb-4 text-gray-900">Community Building</h4>
                <p className="text-gray-800 leading-relaxed">
            ...
            <Card className="text-center hover:scale-105 transition-transform duration-300 bg-white shadow-lg">
              <CardContent className="p-8">
                <div className="flex justify-center mb-6">
                  <img src="/images/Icons/Impact.png?v=2" alt="Economic Impact" className="w-60 h-60 object-contain" />
                </div>
                <h4 className="text-xl font-semibold mb-4 text-gray-900">Economic Impact</h4>
                <p className="text-gray-800 leading-relaxed">
