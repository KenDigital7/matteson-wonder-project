      ...
      <div className="container mx-auto px-4">
        <div className="flex items-center justify-between h-20">
          ...
          <nav className="hidden lg:flex space-x-8">
            <button onClick={() => scrollToSection('mission-vision')} className="text-foreground hover:text-primary transition-colors font-medium">
              Mission & Vision
            </button>
        ...
        {isMenuOpen && (
          <div className="lg:hidden py-4 border-t border-border animate-fade-in">
            <nav className="flex flex-col space-y-4">
              <button onClick={() => scrollToSection('mission-vision')} className="text-left py-2 text-foreground hover:text-primary transition-colors font-medium">
                Mission & Vision
              </button>
